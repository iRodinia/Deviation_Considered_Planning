...
void renderSensedPoints(const ros::TimerEvent& event) {
    ...
    _local_map_pcd.header.frame_id = "global_map";
    pub_cloud.publish(_local_map_pcd);
}

int main(int argc, char** argv) {
    ros::init(argc, argv, "local_sensor_cpu");
    ros::NodeHandle nh("~");

    string global_map_topic, odom_topic;
    ...
    nh.param("camera_odometry_topic", odom_topic, string("odometry"));
    ...
    pub_cloud = nh.advertise<sensor_msgs::PointCloud2>("sim_rendered_pcl", 1);
