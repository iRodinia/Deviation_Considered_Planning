...
public:
    ...
    inline std::vector<signed char> getMapData();
...
inline Eigen::Vector3d GridMap::getOrigin() { return mp_.map_origin_; }

inline std::vector<signed char> GridMap::getMapData(){
